...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] font-sans selection:bg-[var(--accent-primary)] selection:text-white">
      ...
      <main>
        {/* Hero Section */}
        <section className="h-screen min-h-[650px] pt-[72px] flex flex-col items-center justify-center max-w-[1280px] mx-auto px-5 md:px-8">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            <h1 className="text-[36px] md:text-[48px] font-bold leading-[1.15] tracking-[-0.03em] mb-4 text-[var(--text-primary)]">
              Build software at the speed of thought.
            </h1>
            <p className="text-[16px] md:text-[18px] leading-[1.6] text-[var(--text-secondary)] mb-8 max-w-2xl">
              A serious AI operating system for building internal tools. Describe your data models and workflows, and our advanced generative AI will provision the full-stack app instantly.
            </p>
            
            <form onSubmit={handleGenerate} className="w-full bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-[28px] p-[24px] shadow-soft max-w-2xl text-left">
              <input 
                type="text" 
                value={prompt}
        ...
        <section id="how-it-works" className="py-[120px]">
          <div className="max-w-[1280px] mx-auto px-5 md:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] p-8 rounded-[24px] shadow-soft">
        ...
        <section className="py-[120px] max-w-[1280px] mx-auto px-5 md:px-8 text-center">
          ...
          <p className="text-[18px] text-[var(--text-secondary)] max-w-2xl mx-auto mb-12">Our engine integrates directly with Google Gemini Flash to generate flawless schemas and robust interfaces with unprecedented speed.</p>
        ...
        {/* Templates Showcase */}
        <section id="templates" className="py-[120px] overflow-hidden">
          ...
          <div className="max-w-[1280px] mx-auto px-5 md:px-8">
            <div className="flex gap-6 overflow-x-auto pb-8 snap-x snap-mandatory hide-scrollbar">
              {TEMPLATES.map((t, i) => (
                <div key={t.id} className="min-w-[320px] max-w-[320px] bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-[24px] p-6 snap-start flex flex-col shadow-soft transition-transform hover:-translate-y-1">
        ...
        <section id="enterprise" className="py-[120px] max-w-[1280px] mx-auto px-5 md:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[18px] text-[var(--text-secondary)] mb-6">Whether you are in Ops, Sales, or HR, our AI platform provides the primitives to build exactly what your workflow demands without waiting for engineering.</p>
            ...
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] p-10 rounded-[32px] shadow-soft">
              ...
              <p className="text-[15px] text-[var(--text-secondary)] mb-8 leading-relaxed">Your data is yours. The AI engine generates standard Next.js and Prisma code that can be exported or deployed securely to your own infrastructure.</p>
        ...
        <section id="pricing" className="py-[120px]">
          <div className="max-w-[1280px] mx-auto px-5 md:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {/* Standard */}
              <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-[24px] p-[24px] flex flex-col shadow-soft">
                ...
                <button onClick={() => window.scrollTo({top:0, behavior:'smooth'})} className="flex items-center justify-center h-[44px] w-full bg-[var(--bg-primary)] border border-[var(--border-color)] hover:bg-[#FAFAFA] text-[var(--text-primary)] text-[14px] font-semibold rounded-[10px] transition-colors">Start Building</button>
              </div>
              ...
              <div className="bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-[24px] p-[24px] flex flex-col shadow-soft">
                ...
                <button onClick={() => window.scrollTo({top:0, behavior:'smooth'})} className="flex items-center justify-center h-[44px] w-full bg-[#FF6600] hover:bg-[#e55c00] text-white text-[14px] font-semibold rounded-[10px] transition-transform hover:-translate-y-px">Get Started</button>
              </div>

              {/* Yearly */}
              <div className="bg-[var(--bg-secondary)] border-[1.5px] border-[#FF6600] rounded-[24px] p-[24px] flex flex-col relative shadow-xl transform md:-translate-y-2">
        ...
        <section className="py-[120px] max-w-[800px] mx-auto px-5 md:px-8">
          ...
          <div className="space-y-4">
            {[
              { q: 'Can I export the code?', a: 'Yes. Generated apps are standard Next.js and Prisma codebases. You can export the full repository.' },
